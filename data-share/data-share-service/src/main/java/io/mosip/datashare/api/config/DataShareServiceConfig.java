...
public class DataShareServiceConfig {
	...
	private static final Logger logger = LoggerFactory.getLogger(DataShareServiceConfig.class);
	...
	public OpenAPI openApi() {
		...
		if (null != openApiProperties.getDataShareServiceServer().getServers()) {
			openApiProperties.getDataShareServiceServer().getServers().forEach(server -> {
